...
/** 
 * DAO for table M__ACTION__STATUS.
*/
public class M_ACTION_STATUSDao extends AbstractDao<M_ACTION_STATUS, Long> {

    public static final String TABLENAME = "M__ACTION__STATUS";

    /**
     * Properties of entity M_ACTION_STATUS.<br/>
    ...
    */
    ...
    public M_ACTION_STATUSDao(DaoConfig config) {
        super(config);
    }
    
    public M_ACTION_STATUSDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'M__ACTION__STATUS' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'M__ACTION__STATUS'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, M_ACTION_STATUS entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public M_ACTION_STATUS readEntity(Cursor cursor, int offset) {
        M_ACTION_STATUS entity = new M_ACTION_STATUS( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, M_ACTION_STATUS entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(M_ACTION_STATUS entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(M_ACTION_STATUS entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
