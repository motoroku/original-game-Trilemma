...
public class LEARNED_SKILLDao extends AbstractDao<LEARNED_SKILL, Long> {
    ...
    */
    ...
    private Query<LEARNED_SKILL> cHARACTER_SkillListQuery;
    ...
    /** Internal query to resolve the "skillList" to-many relationship of CHARACTER. */
    public List<LEARNED_SKILL> _queryCHARACTER_SkillList(long character_id) {
        synchronized (this) {
            if (cHARACTER_SkillListQuery == null) {
                QueryBuilder<LEARNED_SKILL> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.Character_id.eq(null));
                cHARACTER_SkillListQuery = queryBuilder.build();
            }
        }
        Query<LEARNED_SKILL> query = cHARACTER_SkillListQuery.forCurrentThread();
