...
/** 
 * DAO for table EXP__TABLE.
*/
public class EXP_TABLEDao extends AbstractDao<EXP_TABLE, Long> {

    public static final String TABLENAME = "EXP__TABLE";

    /**
     * Properties of entity EXP_TABLE.<br/>
    ...
    */
    ...
    public EXP_TABLEDao(DaoConfig config) {
        super(config);
    }
    
    public EXP_TABLEDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'EXP__TABLE'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, EXP_TABLE entity) {
        stmt.clearBindings();
        ...
        Integer necessary_exp = entity.getNecessary_exp();
    ...
    /** @inheritdoc */
    @Override
    public EXP_TABLE readEntity(Cursor cursor, int offset) {
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, EXP_TABLE entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(EXP_TABLE entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(EXP_TABLE entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
