...
public class CHARACTER {
    ...
    public CHARACTER(Long id, String character_name, Integer image_no, Integer level, Integer max_hp, Integer max_sp, Integer base_sp, Integer attack_power, Integer defense_power, Integer base_attack_rate, Integer base_defense_rate, Integer base_charge_rate, Integer profit_gold, Integer profit_exp, java.util.Date last_updatetime, Long dungeon_id) {
        this.id = id;
    ...
    public List<LEARNED_SKILL> getSkillList() {
        if (skillList == null) {
            ...
            List<LEARNED_SKILL> skillListNew = targetDao._queryCHARACTER_SkillList(id);
            synchronized (this) {
                if(skillList == null) {
