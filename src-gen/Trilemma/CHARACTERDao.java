...
public class CHARACTERDao extends AbstractDao<CHARACTER, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Last_updatetime = new Property(14, java.util.Date.class, "last_updatetime", false, "LAST_UPDATETIME");
        public final static Property Dungeon_id = new Property(15, Long.class, "dungeon_id", false, "DUNGEON_ID");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'CHARACTER' (" + //
                ...
                "'LAST_UPDATETIME' INTEGER," + // 14: last_updatetime
                "'DUNGEON_ID' INTEGER);"); // 15: dungeon_id
    }
    ...
    protected void bindValues(SQLiteStatement stmt, CHARACTER entity) {
        ...
        if (last_updatetime != null) {
            stmt.bindLong(15, last_updatetime.getTime());
        }
 
        Long dungeon_id = entity.getDungeon_id();
        if (dungeon_id != null) {
            stmt.bindLong(16, dungeon_id);
        }
    }
    ...
    public CHARACTER readEntity(Cursor cursor, int offset) {
        CHARACTER entity = new CHARACTER( //
            ...
            cursor.isNull(offset + 14) ? null : new java.util.Date(cursor.getLong(offset + 14)), // last_updatetime
            cursor.isNull(offset + 15) ? null : cursor.getLong(offset + 15) // dungeon_id
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, CHARACTER entity, int offset) {
        ...
        entity.setLast_updatetime(cursor.isNull(offset + 14) ? null : new java.util.Date(cursor.getLong(offset + 14)));
        entity.setDungeon_id(cursor.isNull(offset + 15) ? null : cursor.getLong(offset + 15));
     }
